...
- [!] T24 [H] Store beyanları, gizlilik ve hukuk — taslak hazır, yayın onayı kullanıcıda (2026-09-20, Kimi K3)
  - Done when: `flutter analyze --fatal-infos ve flutter test` geçer; yukarıdaki Kanıt senaryolarının her biri gözlenmiş sonuçla kaydedilir. Platform/hukuk kanıtı gerekiyorsa otomatik test tek başına kapatmaz.
...
- [!] T23.1 [H] Android güvenli depolama açılış hatasını veri kaybetmeden incele — migration matrisi eski-dep pin'i gerektiriyor
  ...
  - Note: 2026-09-21 (2) **Koşucu hazır: `tool/t231_migration.py --old <eski-apk> --new <yeni-apk>`** — Phase A onboarding+veri, Phase B upgrade+doğrulama; cihaz çakışıklığında kendi kendine ABORT (fingerprint boş = süreç hayatta kalamadı; 2026-09-21 koşusu böyle sonlandı). Worktree 11b85d4'e alındı (onboarding UI'lı); backport reçetesi .dart_tool/t231_backport.py. Cihaz sakin koşunca tamamı PASS olur.
