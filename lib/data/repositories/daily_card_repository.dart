...
class DailyCardRepository {
  ...
  List<DailyCard> cards() => [
        ...
        DailyCard(
          ...
          family: ContentFamily.knowledge,
          title: const L10nText(
            en: 'Keeping the schedule is the active ingredient',
            tr: 'Etken madde: programa uymak',
            de: 'Der Wirkstoff ist das Einhalten',
          ),
          body: const L10nText(
            en: 'In the largest scheduled-reduction trial, reduction on its own changed nothing — but people who stuck to their schedule were about twice as likely to be abstinent six months later.',
            tr: 'En büyük programlı azaltma çalışmasında azaltmanın kendisi tek başına bir şey değiştirmedi — ama programına uyanların altı ay sonra bırakmış olma olasılığı yaklaşık iki katıydı.',
            de: 'In der größten Studie zur geplanten Reduktion änderte Reduktion allein nichts — wer den Plan einhielt, war jedoch rund doppelt so häufig abstinent.',
          ),
          minDay: 7,
