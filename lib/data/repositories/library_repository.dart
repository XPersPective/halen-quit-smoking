...
class LibraryRepository {
  ...
  List<SosTechnique> sosTechniques() => const [
        ...
        SosTechnique(
          ...
          evidenceNote: L10nText(
            en: 'Slow breathing may help some people settle acute arousal; this study was not a smoking-cessation trial.',
            tr: 'Yavaş nefes bazı kişilerde anlık bedensel uyarılmayı yatıştırabilir; bu çalışma sigara bırakma denemesi değildi.',
            de: 'Langsames Atmen kann manchen Menschen bei akuter Anspannung helfen; diese Studie war keine Rauchstopp-Studie.',
          ),
          durationSeconds: 60,
        ...
        SosTechnique(
          ...
          instruction: L10nText(
            en: 'Eat or drink something you tolerate, and keep caffeine steady if it triggers you. This is comfort support, not a nicotine-clearing treatment.',
            tr: 'İyi tolere ettiğin bir şey yiyip iç; kafein seni tetikliyorsa miktarı sabit tut. Bu rahatlama desteğidir, nikotini temizleyen bir tedavi değildir.',
            de: 'Iss oder trink etwas, das du gut verträgst, und halte Koffein konstant, wenn es dich triggert. Das unterstützt Komfort, ist aber keine Behandlung zum Nikotinabbau.',
          ),
          evidence: EvidenceLevel.promising,
          evidenceNote: L10nText(
            en: 'There is no good evidence that vitamin C, alkaline foods or cold water speed quitting. Use this card only as a low-risk comfort and routine-interruption option.',
            tr: 'C vitamini, alkali gıdalar veya soğuk suyun bırakmayı hızlandırdığına dair iyi kanıt yoktur. Bu kartı yalnızca düşük riskli rahatlama ve rutini bölme seçeneği olarak kullan.',
            de: 'Es gibt keine gute Evidenz, dass Vitamin C, basische Kost oder kaltes Wasser das Aufhören beschleunigen. Nutze die Karte nur als risikoarme Komfort- und Unterbrechungsoption.',
          ),
          durationSeconds: 120,
