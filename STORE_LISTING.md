...
Fiyat: ücretsiz indirme; tek seferlik "Halen Lifetime" (mağaza konsolunda
fiyatlandırılır: ABD $14,99 · TR ₺199,99 · DE €14,99 · UK £12,99).
Abonelik yok, reklam yok, hesap yok.
...
• FREE FOREVER TIER — unlimited logging, savings, day counter, 7-day chart
  and export. Premium (one-time, lifetime) unlocks the adaptive plan, full
  charts, trigger patterns, the complete timeline and SOS toolkit.
...
• SONSUZA DEK ÜCRETSİZ — sınırsız kayıt, tasarruf, gün sayacı, 7 günlük
  grafik ve dışa aktarma ücretsiz. Premium (tek seferlik, ömür boyu) dinamik
  planı, tam grafikleri, tetikleyici desenlerini, tam çizelgeyi ve SOS setini
  açar.
...
• FÜR IMMER KOSTENLOS — unbegrenzte Einträge, Ersparnis, Tageszähler,
  7-Tage-Chart und Export. Premium (einmalig, lebenslang) schaltet Plan,
  alle Charts, Trigger-Muster, die volle Zeitachse und das SOS-Set frei.
